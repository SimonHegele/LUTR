...
def get_transcript(p_tran: Series, a_tran: Series, tran_id: str, gene_id: str) -> DataFrame:
        ...
        return DataFrame({"seqname":    [p_tran["seqname"]],
                          ...
                          "frame":      ["."],
                          "attributes": [attributes_str(attrs)]},
                         columns=gff_columns)
...
def generate_utr_variant(p_tran_slice: DataFrame,
    ...
    transcript = get_transcript(p_tran, a_tran, tran_id, gene_id)
